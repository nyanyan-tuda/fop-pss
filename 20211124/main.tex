...
\begin{document}
        ...
        \begin{minipage}{.475\linewidth}
            \begin{figure}[ht]
                ...
                \begin{tikzpicture}
                    \def\width{2.25}
                    \def\height{3}
                    \draw[fill = white, rounded corners, ultra thick] (0, 0)
    ...
    \begin{frame}{Klassenattribute}
        \begin{itemize}
            ...
            \item Formaler Aufbau: Zugriffsmodifikator\(^+\) \inlinejava{static} Datentyp
            Bezeichner = Wert;
            \begin{itemize}
    ...
    \begin{frame}{Primitive Datentypen - Widening conversion}
        \begin{itemize}
            ...
            \item Konvertierung von Typ mit kleinerem (oder schmalerem) in einen Typ mit größerem
            (oder breiterem) Bereich
    ...
    \begin{frame}{Primitive Datentypen - Narrowing conversion}
        \begin{itemize}
            ...
            \item Konvertierung von Typ mit größerem (oder breiterem) in einen Typ mit kleinerem
            (oder schmalerem) Bereich
    ...
    \begin{frame}{Referenztypen}
        ...
        \begin{figure}[h]
            ...
            \begin{tikzpicture}[
                ...
                \draw[-stealth, thick] (parent.east) to[bend left=50] node[above, rotate=-90]
                    {Downcast}
                (child.east);
