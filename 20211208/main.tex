...
\begin{document}
  ...
  \begin{frame}{Formaler Aufbau}
    ...
    \begin{itemize}
      ...
      zurückgeben soll, dann ist die letzte Anweisung ein \inlinejava{return}-Anweisung.
    \end{itemize}
  \end{frame}
  ...
  \begin{frame}{Beispiel}
    ...
    \end{itemize}
    \lstinputlisting[style=Java, title=Interface IntFunction]{codes/IntFunction.java}
  \end{frame}

  \begin{frame}
    \lstinputlisting[style=Java, title=IntFunction Lambda]{codes/IntFunction_Lambda.java}
  \end{frame}
  ...
  \begin{frame}{Anonyme Klasse}
    ...
    \lstinputlisting[style=Java, title=IntFunction Anonyme Klasse]
  ...
  \begin{frame}{Nützliche Informationen}
    ...
    \lstinputlisting[style=Java]{codes/IntFunction_lambda_anonyme_class.java}
  \end{frame}
